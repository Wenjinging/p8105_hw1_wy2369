...
For `vec_df` and `vec_logical`, the mean value can be determined. However, the mean output of `vec_char` and `vec_factor` are NA because they are not numeric variables. 
