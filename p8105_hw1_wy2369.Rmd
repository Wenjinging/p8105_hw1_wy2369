...
Using the code chunk, logical and factor variables are converted to numeric variables, and can take the mean. However the character variable cannot be converted.